...
E10_MapEvents:
	...
	coord_event  6,  2, SCENE_RANDOMSTAIRS, RandomStairWarpE10c
	coord_event  7,  2, SCENE_RANDOMSTAIRS, RandomStairWarpE10c
	...
	object_event  4,  4, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 1, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Monster5E10, -1
	object_event  6,  3, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, E10Item1, EVENT_TEMPORARY_UNTIL_MAP_RELOAD_1
