...
A2_MapEvents:
	...
	object_event 13,  3, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, A2Item1, EVENT_TEMPORARY_UNTIL_MAP_RELOAD_1
	object_event 12,  3, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, A2Item2, EVENT_TEMPORARY_UNTIL_MAP_RELOAD_1
