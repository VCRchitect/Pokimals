...
GetPlayerIcon:
	...
	jr z, .got_gfx
; Drake
	ld de, DrakeSpriteGFX
	ld b, BANK(DrakeSpriteGFX)
...
DrakeCardPic:
INCBIN "gfx/trainer_card/drake_card.2bpp"
...
GetDrakeBackpic:
	ld de, DrakeBackpic
	ld hl, vTiles2 tile $31
	lb bc, BANK(DrakeBackpic), 7 * 7 ; dimensions
	call Get2bpp
	ret
	
DrakeBackpic:
INCBIN "gfx/player/drake_back.2bpp"
