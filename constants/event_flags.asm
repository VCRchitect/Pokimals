...
; Johto hidden items
	...
	const EVENT_WRONGEDJOSE
	const EVENT_WRONGEDCUTIE
...
; More Crystal-exclusive events in Johto
	...
	const EVENT_SECRET_ELEVATOR_OPEN
	const EVENT_SECRET_ELEVATOR_CLOSED
...
; Swimmer F
	...
	const EVENT_BEAT_SWIMMERF_ARNOLD
...
; Johto itemballs
	const EVENT_SKUNK_POKEBALL_IN_RUINS
	const EVENT_SEA_TURTLE_POKEBALL_IN_RUINS
	const EVENT_SQUIRREL_POKEBALL_IN_RUINS
	const EVENT_SCRAWNY_POKEBALL_IN_RUINS
	const EVENT_BAT_POKEBALL_IN_RUINS
	const EVENT_RAPTOR_POKEBALL_IN_RUINS
	const EVENT_ROCKY_POKEBALL_IN_RUINS
	const EVENT_BAG_LADY_POKEBALL_IN_RUINS
	const EVENT_SERPENT_POKEBALL_IN_RUINS
	const EVENT_LARVA_POKEBALL_IN_RUINS
	const EVENT_DRIFTER_POKEBALL_IN_RUINS
	const EVENT_LAMB_POKEBALL_IN_RUINS	
