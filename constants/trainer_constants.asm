...
NUM_TRAINER_CLASSES EQU __trainer_class__ - 1
	...
	const_def
	const RANDOMLIST_TPAIN
	const RANDOMLIST_LARA
	...
	const RANDOMLIST_BRUNO
	const RANDOMLIST_KOGA
	const RANDOMLIST_KAREN
	const RANDOMLIST_LANCE
	const RANDOMLIST_GRUNTM_1
	const RANDOMLIST_GRUNTM_2
