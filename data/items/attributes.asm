...
; BRIGHTPOWDER
	item_attribute 1000, HELD_BRIGHTPOWDER, 20, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; GREAT_BALL
...
; QUICK_CLAW
	item_attribute 1500, HELD_QUICK_CLAW, 60, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; PSNCUREBERRY
	item_attribute 500, HELD_HEAL_POISON, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; GOLD_LEAF
	item_attribute 1000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SOFT_SAND
	item_attribute 1500, HELD_GROUND_BOOST, 10, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SHARP_BEAK
	item_attribute 1500, HELD_FLYING_BOOST, 10, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; PRZCUREBERRY
	item_attribute 500, HELD_HEAL_PARALYZE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; BURNT_BERRY
	item_attribute 500, HELD_HEAL_FREEZE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; ICE_BERRY
	item_attribute 500, HELD_HEAL_BURN, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; POISON_BARB
	item_attribute 1500, HELD_POISON_BOOST, 10, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; KINGS_ROCK
	item_attribute 1500, HELD_FLINCH, 30, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BITTER_BERRY
	item_attribute 500, HELD_HEAL_CONFUSION, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_PARTY
; MINT_BERRY
...
; SILVERPOWDER
	item_attribute 1500, HELD_BUG_BOOST, 10, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLU_APRICORN
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; FLASHLIGHT
	item_attribute 1000, HELD_NONE, 0, CANT_TOSS, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; AMULET_COIN
	item_attribute 100, HELD_AMULET_COIN, 10, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; YLW_APRICORN
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; GRN_APRICORN
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
...
; MYSTIC_WATER
	item_attribute 1500, HELD_WATER_BOOST, 10, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; TWISTEDSPOON
	item_attribute 1500, HELD_PSYCHIC_BOOST, 10, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; WHT_APRICORN
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLACKBELT_I
	item_attribute 1500, HELD_FIGHTING_BOOST, 10, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLK_APRICORN
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLENDER
	item_attribute 1000, HELD_NONE, 0, CANT_TOSS, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; PNK_APRICORN
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLACKGLASSES
	item_attribute 1500, HELD_DARK_BOOST, 10, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BEAVERTAIL
	item_attribute 9800, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; PINK_BOW
	item_attribute 1500, HELD_NORMAL_BOOST, 10, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; STICK
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SMOKE_BALL
	item_attribute 200, HELD_ESCAPE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; NEVERMELTICE
	item_attribute 1500, HELD_ICE_BOOST, 10, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; POLEMAGNET
	item_attribute 1500, HELD_ELECTRIC_BOOST, 10, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MIRACLEBERRY
...
; EVERSTONE
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SPELL_TAG
	item_attribute 1500, HELD_GHOST_BOOST, 10, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; RAGECANDYBAR
	item_attribute 300, HELD_NONE, 20, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; GS_BALL
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLUE_CARD
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; MIRACLE_SEED
	item_attribute 1500, HELD_GRASS_BOOST, 10, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; THICK_CLUB
	item_attribute 500, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; FOCUS_BAND
	item_attribute 2500, HELD_FOCUS_BAND, 30, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; RECYCLA_BALL
...
; HARD_STONE
	item_attribute 1500, HELD_ROCK_BOOST, 10, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LUCKY_EGG
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CARD_KEY
...
; ITEM_89
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CHARCOAL
	item_attribute 1500, HELD_FIRE_BOOST, 10, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BERRY_JUICE
	item_attribute 1500, HELD_BERRY, 20, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; SCOPE_LENS
	item_attribute 2500, HELD_CRITICAL_UP, 0, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_8D
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_8E
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; METAL_COAT
	item_attribute 1500, HELD_STEEL_BOOST, 10, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; DRAGON_FANG
	item_attribute 100, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CIGARETTE
	item_attribute 500, HELD_CIGARETTE, 0, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LEFTOVERS
	item_attribute 5000, HELD_LEFTOVERS, 10, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_93
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_94
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
...
; DRAGON_SCALE
	item_attribute 1500, HELD_DRAGON_BOOST, 10, CANT_SELECT, HELDITEMS, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BERSERK_GENE
	item_attribute 3500, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_99
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_9A
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
...
; BERRY
	item_attribute 500, HELD_BERRY, 10, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; GOLD_BERRY
