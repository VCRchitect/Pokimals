...
MapGroup_Ruins:
	table_width MAP_LENGTH, MapGroup_Ruins
	map A1, TILESET_RUIN_CAVE, CAVE, LANDMARK_THE_RUINS, MUSIC_RIVAL_ENCOUNTER, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map A2, TILESET_RUIN_CAVE, CAVE, LANDMARK_THE_RUINS, MUSIC_RIVAL_ENCOUNTER, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map A3, TILESET_RUIN_CAVE, CAVE, LANDMARK_THE_RUINS, MUSIC_RIVAL_ENCOUNTER, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map A4, TILESET_RUIN_CAVE, CAVE, LANDMARK_THE_RUINS, MUSIC_RIVAL_ENCOUNTER, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map A5, TILESET_RUIN_CAVE, CAVE, LANDMARK_THE_RUINS, MUSIC_RIVAL_ENCOUNTER, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map A6, TILESET_RUIN_CAVE, CAVE, LANDMARK_THE_RUINS, MUSIC_RIVAL_ENCOUNTER, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map A7, TILESET_RUIN_CAVE, CAVE, LANDMARK_THE_RUINS, MUSIC_RIVAL_ENCOUNTER, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map A8, TILESET_RUIN_CAVE, CAVE, LANDMARK_THE_RUINS, MUSIC_RIVAL_ENCOUNTER, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map A9, TILESET_RUIN_CAVE, CAVE, LANDMARK_THE_RUINS, MUSIC_RIVAL_ENCOUNTER, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map A10, TILESET_RUIN_CAVE, CAVE, LANDMARK_THE_RUINS, MUSIC_RIVAL_ENCOUNTER, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	assert_table_length NUM_RUINS_MAPS