...
; SPRITE_ANIM_INDEX_INTRO_GERBIL
	db SPRITE_ANIM_FRAMESET_INTRO_GERBIL,               SPRITE_ANIM_SEQ_INTRO_GERBIL_AXOLOTL,        SPRITE_ANIM_DICT_DEFAULT
; SPRITE_ANIM_INDEX_INTRO_AXOLOTL
	db SPRITE_ANIM_FRAMESET_INTRO_AXOLOTL,              SPRITE_ANIM_SEQ_INTRO_GERBIL_AXOLOTL,        SPRITE_ANIM_DICT_DEFAULT
...
; SPRITE_ANIM_INDEX_CELEBI
	...
	db SPRITE_ANIM_FRAMESET_DRAKE_WALK,               SPRITE_ANIM_SEQ_NULL,             				SPRITE_ANIM_DICT_DEFAULT
	db SPRITE_ANIM_FRAMESET_MAGNET_TRAIN_DRAKE,       SPRITE_ANIM_SEQ_NULL,                    SPRITE_ANIM_DICT_DEFAULT
